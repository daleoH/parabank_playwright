...
test.describe(" Registration tests", async () => {
    ...
    test("Successfully Register Account", async ({page}) => {
        ...
        await page.locator('[id="customer.firstName"]').fill(generateName);
        await page.locator('[id="customer.lastName"]').fill(generateName);
        ...
        await page.locator('[id="customer.phoneNumber"]').fill('077' + generateNumber);
